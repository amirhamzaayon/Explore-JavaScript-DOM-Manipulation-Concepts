...
document.addEventListener("DOMContentLoaded", function () {
  ...
  for (const card of donationCards) {
    ...
    donateButton.addEventListener("click", function () {
      ...
      // Show success alert
      alert(
        `Successfully donated ${donationAmount} BDT for ${
  ...
  function addHistoryCard(donationAmount, cause) {
    ...
    historyCard.className =
      "history-card sm:w-[1076px] w-[400px] flex flex-col gap-8 p-8 border-2 rounded-lg border-[#171717]/[.1]";
...
>>>>>>> 6d2f37a (connect with github repo)
